import{_ as a,c as r,o as s,ah as o,j as e,a as n}from"./chunks/framework.PvdZnrZd.js";const u=JSON.parse('{"title":"Transaction Charges","description":"Transaction Charges","frontmatter":{"title":"Transaction Charges","description":"Transaction Charges","author":"Chirag Tyagi"},"headers":[],"relativePath":"zenith/products/transaction-charges.md","filePath":"zenith/products/transaction-charges.md"}'),l={name:"zenith/products/transaction-charges.md"};function i(c,t,d,m,g,p){return s(),r("div",null,[...t[0]||(t[0]=[o('<h1 id="user-guide-for-transaction-charges" tabindex="-1">User Guide for Transaction Charges <a class="header-anchor" href="#user-guide-for-transaction-charges" aria-label="Permalink to &quot;User Guide for Transaction Charges&quot;">​</a></h1><p>Here in the blog, we will understand <strong>how to manage transaction charges</strong> on orders placed via <strong><a href="/zenith/introduction/">Multivendor Marketplace for Shopify</a></strong>. Before we move further, let&#39;s understand what are handling &amp; transaction charges.</p><h2 id="what-is-handling-transaction-charge" tabindex="-1"><strong>What is</strong> <strong>Handling &amp; Transaction Charge</strong> ? <a class="header-anchor" href="#what-is-handling-transaction-charge" aria-label="Permalink to &quot;**What is** **Handling &amp; Transaction Charge** ?&quot;">​</a></h2><p><strong>Handling Charges</strong> are basically charge levied on a customer to cover the seller&#39;s fulfillment costs including storing, packing, and sending an order to destination. It is charged on top of the order subtotal and shipping fees.</p><p><strong>Transaction Charges</strong> are the charges businesses pay a service provider each time a customer payment is processed online for an order. It can vary depending on the service provider.</p><p>In most of the case, it happens that the store merchant has to bear the handling and transaction charges levied on every transaction. So, with the Sales Price feature, you can add these charges to the product price while creating the product.</p><p>So, if you <strong>enable</strong> the <strong>Display Sales Price On Product</strong>, <strong><a href="/zenith/products/handling-and-transaction-charges.html">this is how</a></strong> you can manage the handling and transaction charges. <a href="/zenith/products/handling-and-transaction-charges.html">Check the Guide</a> !</p>',7),e("p",null,[e("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2021/07/screenshot-sp-seller.webkul.com-2021.07.05-16_13_04-1200x549.png",alt:"sales prica",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        ...
        img.src = "https://cdnblog.webkul.com/blog/wp-content/uploads/2021/07/screenshot-sp-seller.webkul.com-2021.07.05-16_13_04-1200x549.png";
      ...
      `})],-1),e("p",null,"If the Sales Price tab is ON, the seller will bear the handling charge while the transaction charge will always bear by the admin.",-1),e("p",null,[n("However, if the Display Sales Price on Products tab is "),e("strong",null,"OFF"),n(", you can "),e("strong",null,"allow sellers to bear the transaction charge"),n(".")],-1),e("p",null,[e("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2021/07/screenshot-sp-seller.webkul.com-2021.07.05-17_16_38-1200x549.png",alt:"transaction charges",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        ...
        const img = document.createElement('img');
        img.src = "https://cdnblog.webkul.com/blog/wp-content/uploads/2021/07/screenshot-sp-seller.webkul.com-2021.07.05-17_16_38-1200x549.png";
      ...
      `})],-1),e("p",null,"Let's understand how you can manage the transaction charges separately on orders.",-1),e("p",null,[n("So, visit the Multi-vendor admin panel>>Go to Configuration>>"),e("strong",null,"Product Configuration"),n(" and "),e("strong",null,"enable the"),n(),e("strong",null,"Transaction Charges"),n(" tab.")],-1),e("p",null,[e("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2022/04/transaction-1200x491.png",alt:"transaction",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        ...
        const img = document.createElement('img');
        img.src = "https://cdnblog.webkul.com/blog/wp-content/uploads/2022/04/transaction-1200x491.png";
      ...
      `})],-1),e("p",null,[e("strong",null,"Order Detail Page:")],-1),e("p",null,[e("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2021/07/screenshot-ravikant-sh.webkul.com-2021.07.05-18_04_19-1035x1024.png",alt:"transaction charge on order page",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        const existing = document.getElementById('wk-image-overlay');
        if(existing) existing.remove();
        ...
        const img = document.createElement('img');
        img.src = "https://cdnblog.webkul.com/blog/wp-content/uploads/2021/07/screenshot-ravikant-sh.webkul.com-2021.07.05-18_04_19-1035x1024.png";
      ...
      `})],-1),e("p",null,[e("strong",null,"Commission Listing page"),n(":")],-1),e("p",null,[e("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2021/07/screenshot-nimbusweb.me-2021.07.05-19_00_03.png",alt:"transaction charge",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        const existing = document.getElementById('wk-image-overlay');
        if(existing) existing.remove();
        ...
        const img = document.createElement('img');
        img.src = "https://cdnblog.webkul.com/blog/wp-content/uploads/2021/07/screenshot-nimbusweb.me-2021.07.05-19_00_03.png";
      ...
      `})],-1),e("p",null,[e("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2021/07/screenshot-nimbusweb.me-2021.07.05-18_56_31-1.png",alt:"screenshot-nimbusweb.me-2021.07.05-18_56_31-1",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        const existing = document.getElementById('wk-image-overlay');
        if(existing) existing.remove();
        ...
        const img = document.createElement('img');
        img.src = "https://cdnblog.webkul.com/blog/wp-content/uploads/2021/07/screenshot-nimbusweb.me-2021.07.05-18_56_31-1.png";
      ...
      `})],-1),e("p",null,"Transaction charges on Seller Panel:",-1),e("p",null,[e("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2021/07/screenshot-nimbusweb.me-2021.07.05-18_58_38.png",alt:"seller end",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        const existing = document.getElementById('wk-image-overlay');
        if(existing) existing.remove();
        ...
        const img = document.createElement('img');
        img.src = "https://cdnblog.webkul.com/blog/wp-content/uploads/2021/07/screenshot-nimbusweb.me-2021.07.05-18_58_38.png";
