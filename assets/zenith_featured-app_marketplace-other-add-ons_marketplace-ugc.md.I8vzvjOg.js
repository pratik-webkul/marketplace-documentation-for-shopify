import{_ as l,c as a,o as r,ah as o,j as n,a as e}from"./chunks/framework.PvdZnrZd.js";const h=JSON.parse('{"title":"Marketplace UGC","description":"Marketplace UGC","frontmatter":{"title":"Marketplace UGC","description":"Marketplace UGC","author":"Chirag Tyagi"},"headers":[],"relativePath":"zenith/featured-app/marketplace-other-add-ons/marketplace-ugc.md","filePath":"zenith/featured-app/marketplace-other-add-ons/marketplace-ugc.md"}'),i={name:"zenith/featured-app/marketplace-other-add-ons/marketplace-ugc.md"};function s(c,t,d,m,p,g){return r(),a("div",null,[...t[0]||(t[0]=[o('<h1 id="user-guide-for-marketplace-ugc" tabindex="-1">User Guide for Marketplace Ugc <a class="header-anchor" href="#user-guide-for-marketplace-ugc" aria-label="Permalink to &quot;User Guide for Marketplace Ugc&quot;">​</a></h1><h2 id="marketplace-ugc-feature-app-multivendor-marketplace" tabindex="-1">Marketplace UGC Feature App - Multivendor Marketplace <a class="header-anchor" href="#marketplace-ugc-feature-app-multivendor-marketplace" aria-label="Permalink to &quot;Marketplace UGC Feature App - Multivendor Marketplace&quot;">​</a></h2><h2 id="introduction" tabindex="-1">Introduction <a class="header-anchor" href="#introduction" aria-label="Permalink to &quot;Introduction&quot;">​</a></h2><p><strong>Marketplace UGC (User Generated Content)</strong> allows sellers to showcase real customer or creator content such as <strong>videos, posts, and reviews</strong> directly on their product pages.</p><p>This helps to:</p><ul><li>Build <strong>trust</strong></li><li>Improve <strong>engagement</strong></li><li>Increase <strong>conversions</strong></li></ul><h2 id="how-to-enable-the-feature" tabindex="-1">How to Enable the Feature <a class="header-anchor" href="#how-to-enable-the-feature" aria-label="Permalink to &quot;How to Enable the Feature&quot;">​</a></h2><p>To enable this feature, the admin needs to:</p><p><strong>Navigate to:</strong></p><p><strong>Admin Panel → Feature App → Enable Marketplace UGC Feature App</strong></p><p>After enabling, a <strong>UGC Configuration</strong> section will appear under the <strong>Configuration menu</strong>.</p>',11),n("p",null,[n("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2026/05/ugc1.webp",alt:"Enable UGC Feature",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
      ...
      `})],-1),o('<h2 id="ugc-marketplace-section" tabindex="-1">UGC Marketplace Section <a class="header-anchor" href="#ugc-marketplace-section" aria-label="Permalink to &quot;UGC Marketplace Section&quot;">​</a></h2><p>After enabling the feature:</p><p>A new section <strong>“UGC Marketplace”</strong> will appear in both:</p><ul><li><strong>Admin Panel</strong></li><li><strong>Seller Panel</strong></li></ul><p>This section displays all UGC listings added by seller staff.</p>',5),n("p",null,[n("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2026/05/ugc3.webp",alt:"UGC Admin View",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        const existing = document.getElementById('wk-image-overlay');
        if(existing) existing.remove();
      ...
      `})],-1),n("p",null,[n("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2026/05/ugc4.webp",alt:"UGC Seller View",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        const existing = document.getElementById('wk-image-overlay');
        if(existing) existing.remove();
      ...
      `})],-1),n("h2",{id:"seller-staff-end-–-adding-ugc",tabindex:"-1"},[e("Seller Staff End – Adding UGC "),n("a",{class:"header-anchor",href:"#seller-staff-end-–-adding-ugc","aria-label":'Permalink to "Seller Staff End – Adding UGC"'},"​")],-1),n("ol",null,[n("li",null,"Seller staff logs into their dashboard"),n("li",null,[e("Navigate to:"),n("br"),n("strong",null,"UGC Marketplace → UGC Listing")]),n("li",null,[e("Click on "),n("strong",null,"“Add UGC”")])],-1),n("p",null,[n("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2026/05/ugc5.webp",alt:"Add UGC",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        const existing = document.getElementById('wk-image-overlay');
        if(existing) existing.remove();
      ...
      `})],-1),o('<h2 id="submitting-the-ugc" tabindex="-1">Submitting the UGC <a class="header-anchor" href="#submitting-the-ugc" aria-label="Permalink to &quot;Submitting the UGC&quot;">​</a></h2><p>Once the seller staff submits the UGC:</p><ul><li>It is sent to the <strong>seller for approval</strong></li></ul><h3 id="auto-approve-condition" tabindex="-1">Auto Approve Condition <a class="header-anchor" href="#auto-approve-condition" aria-label="Permalink to &quot;Auto Approve Condition&quot;">​</a></h3><ul><li>If <strong>Auto Approve is disabled</strong> → UGC goes for approval</li><li>If <strong>enabled</strong> → UGC is <strong>automatically approved and published</strong></li></ul>',5),n("p",null,[n("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2026/05/ugc7.webp",alt:"UGC Approval",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        const existing = document.getElementById('wk-image-overlay');
        if(existing) existing.remove();
      ...
      `})],-1),n("h2",{id:"frontend-display",tabindex:"-1"},[e("Frontend Display "),n("a",{class:"header-anchor",href:"#frontend-display","aria-label":'Permalink to "Frontend Display"'},"​")],-1),n("h3",{id:"on-product-page",tabindex:"-1"},[e("On Product Page "),n("a",{class:"header-anchor",href:"#on-product-page","aria-label":'Permalink to "On Product Page"'},"​")],-1),n("p",null,"UGC will be displayed alongside the product.",-1),n("p",null,[n("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2026/05/ugc9.webp",alt:"UGC Product Page",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        const existing = document.getElementById('wk-image-overlay');
        if(existing) existing.remove();
      ...
      `})],-1),n("h3",{id:"on-seller-collection-page",tabindex:"-1"},[e("On Seller Collection Page "),n("a",{class:"header-anchor",href:"#on-seller-collection-page","aria-label":'Permalink to "On Seller Collection Page"'},"​")],-1),n("p",null,"UGC will also be displayed on the seller’s collection page.",-1),n("p",null,[n("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2026/05/ugc10.webp",alt:"UGC Collection Page",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        const existing = document.getElementById('wk-image-overlay');
        if(existing) existing.remove();
      ...
      `})],-1),n("p",null,[e("This feature enhances your marketplace by leveraging "),n("strong",null,"authentic user-generated content"),e(", helping improve "),n("strong",null,"customer trust, engagement, and overall sales performance"),e(".")],-1),n("h3",{id:"schedule-demo",tabindex:"-1"},[e("SCHEDULE DEMO "),n("a",{class:"header-anchor",href:"#schedule-demo","aria-label":'Permalink to "SCHEDULE DEMO"'},"​")],-1),n("p",null,[n("a",{href:"https://egsma.io/shopify-multivendor-marketplace/",target:"_blank",rel:"noreferrer"},"Click here to Schedule the demo of Multivendor marketplace App for Shopify ")],-1)])])}const y=l(i,[["render",s]]);export{h as __pageData,y as default};
