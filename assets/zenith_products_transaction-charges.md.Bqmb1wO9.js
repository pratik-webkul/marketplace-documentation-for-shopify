import{_ as a,c as r,o as l,ah as o,j as n,a as e}from"./chunks/framework.PvdZnrZd.js";const u=JSON.parse('{"title":"Transaction Charges","description":"Transaction Charges","frontmatter":{"title":"Transaction Charges","description":"Transaction Charges","author":"Chirag Tyagi"},"headers":[],"relativePath":"zenith/products/transaction-charges.md","filePath":"zenith/products/transaction-charges.md"}'),s={name:"zenith/products/transaction-charges.md"};function i(c,t,d,m,p,g){return l(),r("div",null,[...t[0]||(t[0]=[o('<h1 id="user-guide-for-transaction-charges" tabindex="-1">User Guide for Transaction Charges <a class="header-anchor" href="#user-guide-for-transaction-charges" aria-label="Permalink to &quot;User Guide for Transaction Charges&quot;">​</a></h1><p>Here in the blog, we will understand <strong>how to manage transaction charges</strong> on orders placed via <strong><a href="/zenith/introduction/">Multivendor Marketplace for Shopify</a></strong>. Before we move further, let&#39;s understand what are handling &amp; transaction charges.</p><h2 id="what-is-handling-transaction-charge" tabindex="-1"><strong>What is</strong> <strong>Handling &amp; Transaction Charge</strong> ? <a class="header-anchor" href="#what-is-handling-transaction-charge" aria-label="Permalink to &quot;**What is** **Handling &amp; Transaction Charge** ?&quot;">​</a></h2><p><strong>Handling Charges</strong> are basically charge levied on a customer to cover the seller&#39;s fulfillment costs including storing, packing, and sending an order to destination. It is charged on top of the order subtotal and shipping fees.</p><p><strong>Transaction Charges</strong> are the charges businesses pay a service provider each time a customer payment is processed online for an order. It can vary depending on the service provider.</p><p>In most of the case, it happens that the store merchant has to bear the handling and transaction charges levied on every transaction. So, with the Sales Price feature, you can add these charges to the product price while creating the product.</p><p>So, if you <strong>enable</strong> the <strong>Display Sales Price On Product</strong>, <strong><a href="/zenith/products/handling-and-transaction-charges.html">this is how</a></strong> you can manage the handling and transaction charges. <a href="/zenith/products/handling-and-transaction-charges.html">Check the Guide</a> !</p>',7),n("p",null,[n("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2026/05/tcoo1.webp",alt:"sales prica",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
      ...
      `})],-1),n("p",null,"If the Sales Price tab is ON, the seller will bear the handling charge while the transaction charge will always bear by the admin.",-1),n("p",null,[e("However, if the Display Sales Price on Products tab is "),n("strong",null,"OFF"),e(", you can "),n("strong",null,"allow sellers to bear the transaction charge"),e(".")],-1),n("p",null,[n("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2026/05/tcoo3.webp",alt:"transaction charges",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        const existing = document.getElementById('wk-image-overlay');
        if(existing) existing.remove();
      ...
      `})],-1),n("p",null,"Let's understand how you can manage the transaction charges separately on orders.",-1),n("p",null,[e("So, visit the Multi-vendor admin panel>>Go to Configuration>>"),n("strong",null,"Product Configuration"),e(" and "),n("strong",null,"enable the"),e(),n("strong",null,"Transaction Charges"),e(" tab.")],-1),n("p",null,[n("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2026/05/tcoo2.webp",alt:"transaction",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        const existing = document.getElementById('wk-image-overlay');
        if(existing) existing.remove();
      ...
      `})],-1),n("p",null,[n("strong",null,"Order Detail Page:")],-1),n("p",null,[n("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2026/05/tcoo4.webp",alt:"transaction charge on order page",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        const existing = document.getElementById('wk-image-overlay');
        if(existing) existing.remove();
      ...
      `})],-1),n("p",null,[n("strong",null,"Commission Listing page"),e(":")],-1),n("p",null,[n("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2026/05/tcoo5-1.webp",alt:"transaction charge",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        const existing = document.getElementById('wk-image-overlay');
        if(existing) existing.remove();
      ...
      `})],-1),n("p",null,[n("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2026/05/tcoo6-1.webp",alt:"screenshot-nimbusweb.me-2021.07.05-18_56_31-1",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        const existing = document.getElementById('wk-image-overlay');
        if(existing) existing.remove();
      ...
      `})],-1),n("p",null,"Transaction charges on Seller Panel:",-1),n("p",null,[n("img",{src:"https://cdnblog.webkul.com/blog/wp-content/uploads/2026/05/tcoo6-1.webp",alt:"seller end",style:{cursor:"zoom-in","max-width":"100%"},onclick:`
        const existing = document.getElementById('wk-image-overlay');
        if(existing) existing.remove();
