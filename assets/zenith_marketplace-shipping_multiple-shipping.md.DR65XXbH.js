import{_ as l,c as i,o as s,ah as o,j as n,a as e}from"./chunks/framework.PvdZnrZd.js";const h=JSON.parse('{"title":"Multiple Shipping","description":"Multiple Shipping","frontmatter":{"title":"Multiple Shipping","description":"Multiple Shipping","author":"Chirag Tyagi"},"headers":[],"relativePath":"zenith/marketplace-shipping/multiple-shipping.md","filePath":"zenith/marketplace-shipping/multiple-shipping.md"}'),a={name:"zenith/marketplace-shipping/multiple-shipping.md"};function r(c,t,d,m,p,g){return s(),i("div",null,[...t[0]||(t[0]=[o('<h1 id="user-guide-for-multiple-shipping" tabindex="-1">User Guide for Multiple Shipping <a class="header-anchor" href="#user-guide-for-multiple-shipping" aria-label="Permalink to &quot;User Guide for Multiple Shipping&quot;">​</a></h1><p>If you are using <a href="/zenith/marketplace-shipping/marketplace-shipping.html">Multivendor Marketplace Shipping App</a> then now you will be able to <strong>create multiple shipping</strong> for your sellers.</p><p>In this documentation, we will only discuss how the admin can create multiple shipping and further, how the sellers can configure them.</p><p>To learn more about the marketplace shipping app, refer to this <a href="/zenith/marketplace-shipping/marketplace-shipping.html">blog</a>.</p><p><strong>Note</strong>: You will only be able to create multiple shipping if you are using <strong>Zone-Wise</strong> or <strong>Country-wise</strong> shipping type.</p><p>It will not work in the case of the Postcode-wise shipping type.</p><p>In case you want to change the shipping type from zone-wise/country-wise to postcode-wise then you first need to disable multiple shipping. Otherwise, you may face issues.</p><p>Also, if you are using this feature, you won&#39;t be able to fetch shipping rates using any other <a href="https://sp-seller.webkul.com/mvm-landing/addons/" target="_blank" rel="noreferrer">shipping module</a> of the marketplace app.</p><p>However, you can use these shipping modules for the fulfillment process.</p><p>These are all the points that you need to remember. Now, let&#39;s jump into the configuration part!</p><h2 id="enable-multiple-shipping" tabindex="-1">Enable Multiple Shipping <a class="header-anchor" href="#enable-multiple-shipping" aria-label="Permalink to &quot;Enable Multiple Shipping&quot;">​</a></h2><p>The admin needs to visit <strong>Multivendor Admin panel</strong> &gt; <strong>Configuration</strong> &gt; <strong>Marketplace Shipping Configuration</strong>. Here, you need to click on the following option:</p>',12),n("p",null,[n("a",{href:"javascript:void(0)",onclick:`
      ...
      `})])],-1),o('<p>In case you are using the <a href="/zenith/featured-app/marketplace-miscellaneous-add-ons/hyperlocal-marketplace.html"><strong>Hyperlocal Marketplace</strong></a> module, kindly check out: <a href="/zenith/featured-app/marketplace-miscellaneous-add-ons/hyperlocal-marketplace.html#hyperlocal-with-multiple-shipping"><strong>Hyperlocal with Multiple Shipping</strong></a></p><p><strong>Note</strong>: In case you need our help with code pasting, drop your request at <a href="mailto:shopify@webkul.com" target="_blank" rel="noreferrer">shopify@webkul.com</a>.</p><h3 id="case-scenario" tabindex="-1">Case Scenario <a class="header-anchor" href="#case-scenario" aria-label="Permalink to &quot;Case Scenario&quot;">​</a></h3><p><strong>CASE I</strong></p><p>Suppose, Seller has 2 products: <strong>Product A</strong> &amp; <strong>product B</strong></p><p>On product A, let say the seller has chosen: <strong>Method 1</strong> &amp; <strong>Method 2</strong><br> On product B, let say the seller has chosen: <strong>Method 2</strong> &amp; <strong>Method 3</strong></p><p>Then in this case, when customers add product A as well as product B then we&#39;ll get Method 2 common so then we&#39;ll display the shipping rates based on Method 2 on Shopify checkout.</p><p><strong>CASE II</strong></p><p>Suppose, Seller has 2 products: <strong>Product A</strong> &amp; <strong>product B</strong></p><p>On product A, let say the seller has chosen: <strong>Method 1</strong> &amp; <strong>Method 2</strong><br> On product B, let say the seller has chosen: <strong>Method</strong> <strong>3</strong> &amp; <strong>Method</strong> <strong>4</strong></p><p>Then in this case, when customer adds product A as well as product B then we won&#39;t be getting any common shipping method</p><p>so then we won&#39;t be able to display any shipping rates on the checkout page.</p><h2 id="distance-based-shipping-and-shopify-checkout-time-limit" tabindex="-1">Distance-Based Shipping and Shopify Checkout Time Limit <a class="header-anchor" href="#distance-based-shipping-and-shopify-checkout-time-limit" aria-label="Permalink to &quot;Distance-Based Shipping and Shopify Checkout Time Limit&quot;">​</a></h2><p>Shopify requires shipping rates to be returned within <strong>approximately 10 seconds</strong> during checkout. If the Shipping Rate API does not respond within this time limit, Shopify will not display shipping rates to the customer.</p><p>For distance-based shipping, we calculate the distance between the customer&#39;s address and the seller&#39;s location using the <strong>Google Distance Matrix API</strong>. Each distance calculation typically takes around <strong>2–3 seconds</strong>.</p><p>The challenge arises when multiple shipping methods and multiple sellers are involved in the same order.</p><h2 id="example-1-single-seller-with-multiple-shipping-methods" tabindex="-1">Example 1: Single Seller with Multiple Shipping Methods <a class="header-anchor" href="#example-1-single-seller-with-multiple-shipping-methods" aria-label="Permalink to &quot;Example 1: Single Seller with Multiple Shipping Methods&quot;">​</a></h2><p>Suppose <strong>Seller A</strong> has the following distance-based shipping methods:</p><ul><li>Standard Delivery</li><li>Express Delivery</li><li>Same-Day Delivery</li></ul><p>To calculate rates, the system may need to make a separate Google API request for each shipping method.</p><table tabindex="0"><thead><tr><th>API Request</th><th>Estimated Time</th></tr></thead><tbody><tr><td>1st API Call</td><td>2–3 seconds</td></tr><tr><td>2nd API Call</td><td>2–3 seconds</td></tr><tr><td>3rd API Call</td><td>2–3 seconds</td></tr></tbody></table><blockquote><p><strong>Total processing time:</strong> <strong>6–9 seconds</strong> for just one seller.</p></blockquote><h2 id="example-2-multiple-sellers-with-multiple-shipping-methods" tabindex="-1">Example 2: Multiple Sellers with Multiple Shipping Methods <a class="header-anchor" href="#example-2-multiple-sellers-with-multiple-shipping-methods" aria-label="Permalink to &quot;Example 2: Multiple Sellers with Multiple Shipping Methods&quot;">​</a></h2><p>Now consider a cart containing products from two sellers:</p><h3 id="seller-a" tabindex="-1">Seller A <a class="header-anchor" href="#seller-a" aria-label="Permalink to &quot;Seller A&quot;">​</a></h3><ul><li>Standard Delivery</li><li>Express Delivery</li></ul><h3 id="seller-b" tabindex="-1">Seller B <a class="header-anchor" href="#seller-b" aria-label="Permalink to &quot;Seller B&quot;">​</a></h3><ul><li>Standard Delivery</li><li>Express Delivery</li></ul><p>In this case, the system may need to perform four separate distance calculations.</p><table tabindex="0"><thead><tr><th>Seller &amp; Shipping Method</th><th>Estimated Time</th></tr></thead><tbody><tr><td>Seller A + Standard Delivery</td><td>2–3 seconds</td></tr><tr><td>Seller A + Express Delivery</td><td>2–3 seconds</td></tr><tr><td>Seller B + Standard Delivery</td><td>2–3 seconds</td></tr><tr><td>Seller B + Express Delivery</td><td>2–3 seconds</td></tr></tbody></table><blockquote><p><strong>Total processing time:</strong> <strong>8–12 seconds or more.</strong></p></blockquote><p>Since Shopify expects a response within about <strong>10 seconds</strong>, there is a high risk that the request will exceed Shopify&#39;s timeout limit. When that happens, shipping rates may not appear at checkout, resulting in a poor customer experience.</p><h1 id="why-we-support-a-single-distance-based-shipping-method" tabindex="-1">Why We Support a Single Distance-Based Shipping Method <a class="header-anchor" href="#why-we-support-a-single-distance-based-shipping-method" aria-label="Permalink to &quot;Why We Support a Single Distance-Based Shipping Method&quot;">​</a></h1><p>To ensure that shipping rates are returned within Shopify&#39;s required timeframe, we support distance-based calculations using <strong>a single shipping method per seller</strong>.</p><p>With this approach:</p><ul><li>Only <strong>one Google API call</strong> is required for each seller.</li><li>API response time remains significantly lower.</li><li>Even if the cart contains products from multiple sellers, the total processing time generally stays within Shopify&#39;s allowed limit.</li><li>Shipping rates are returned reliably and displayed correctly during checkout.</li></ul><p>This design is implemented specifically to:</p><ul><li>Maintain checkout performance.</li><li>Avoid Shopify timeouts.</li><li>Ensure customers always receive accurate shipping rates without delays.</li></ul><h3 id="schedule-demo" tabindex="-1">SCHEDULE DEMO <a class="header-anchor" href="#schedule-demo" aria-label="Permalink to &quot;SCHEDULE DEMO&quot;">​</a></h3><p><a href="https://egsma.io/shopify-multivendor-marketplace/" target="_blank" rel="noreferrer">Click here to Schedule the demo of Multivendor marketplace App for Shopify </a></p>',40)])])}const y=l(a,[["render",r]]);export{h as __pageData,y as default};
