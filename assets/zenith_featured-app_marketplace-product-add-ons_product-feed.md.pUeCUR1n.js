import{_ as l,c as r,o as a,ah as t,j as n,a as e}from"./chunks/framework.PvdZnrZd.js";const y=JSON.parse('{"title":"PRODUCT FEED","description":"PRODUCT FEED","frontmatter":{"title":"PRODUCT FEED","description":"PRODUCT FEED","date":"2025-08-04T00:00:00.000Z","author":"Chirag Tyagi"},"headers":[],"relativePath":"zenith/featured-app/marketplace-product-add-ons/product-feed.md","filePath":"zenith/featured-app/marketplace-product-add-ons/product-feed.md"}'),s={name:"zenith/featured-app/marketplace-product-add-ons/product-feed.md"};function i(c,o,d,m,p,u){return a(),r("div",null,[...o[0]||(o[0]=[t('<h1 id="user-guide-for-product-feed" tabindex="-1">User Guide for Product Feed <a class="header-anchor" href="#user-guide-for-product-feed" aria-label="Permalink to &quot;User Guide for Product Feed&quot;">​</a></h1><p>A Product Feed includes all the information related to products that are available on the marketplace for sale.</p><p><a href="/zenith/introduction/">Multivendor Marketplace</a> for Shopify has now come up with a new feature app called <strong>Product Feed</strong>.</p><p>It enables the merchants to add products in bulk from different eCommerce platforms into Shopify via XML file upload.</p><p>Using this feature app, you can add feed by uploading an XML file.</p><p>This file is having products along with their information and details such as Product ID, Product Name, Product Price, its quantity and so on.</p><p>Once you enable this feature app installed on your marketplace, $10/month gets added to your current Multivendor Plan.</p><h2 id="feature" tabindex="-1">Feature <a class="header-anchor" href="#feature" aria-label="Permalink to &quot;Feature&quot;">​</a></h2><ul><li>Admin can add Product Feed by uploading XML product file and assign it to any of his registered sellers.</li><li>This XML file is having all the data related to the products that you are selling.</li><li>All the product entities added in your XML file can be mapped with the pre-defined product entities available on your Shopify store.</li><li>Configure all related settings from his/her panel.</li><li>You can set a Price Rule on every feed that you add to your Marketplace.</li><li>Sellers registered on your marketplace can also add Feeds by adding Feed URL.</li></ul><h2 id="limitations" tabindex="-1">Limitations <a class="header-anchor" href="#limitations" aria-label="Permalink to &quot;Limitations&quot;">​</a></h2><p>There are certain limitations of this feature app listed below which you need to know.</p><ul><li>Only XML file is supported while adding products in bulk using this feature app.</li><li>You cannot update the Feed Products.</li><li>You can&#39;t add variant wise Feed Products.</li><li>Multiple images can&#39;t be uploaded for a single Feed Product.</li></ul><h2 id="installation" tabindex="-1">Installation <a class="header-anchor" href="#installation" aria-label="Permalink to &quot;Installation&quot;">​</a></h2>',13),n("p",null,[n("a",{href:"javascript:void(0)",onclick:`
      ...
      `})])],-1),t('<p>Visiting this Product Feed section you need to click on the &quot;<strong>Add Product Feed</strong>&quot; button to add related details of the product Feed.</p><h2 id="add-product-feed" tabindex="-1"><strong>Add Product Feed</strong> <a class="header-anchor" href="#add-product-feed" aria-label="Permalink to &quot;**Add Product Feed**&quot;">​</a></h2><p>There, you need to mention the Feed Name, set a Price Rule for this feed and mention the Start and End node of the feed.</p><p><strong>Feed Name:-</strong> Enter the name of the product feed.</p><p><strong>Price Rule:-</strong> Set the price rule for seller&#39;s feed products, <strong>Increase</strong> (increase the original price with a certain amount),</p><p><strong>Decrease</strong> (decrease the original product price with a certain amount) and <strong>Neutral</strong> (keep the product price as it is).</p><p>Enter the <strong>Start &amp; End Node</strong>. Please refer to the screenshot for reference:-</p><p>Here:-<br> Start Node:- Product<br> End Node:- Product</p>',8),n("p",null,[n("a",{href:"javascript:void(0)",onclick:`
          event.preventDefault();
