...
In case you have enabled the [**Cashable amount**](/zenith/payment/paypal#pay-after-refund-date) the payment will be initiated after the refund days.
...
Now as per the Multivendor [Payment Flow](/zenith/payment/overview#how-admin-pays-to-sellers) when Admin Pays the Seller due amount through RazorPayX.
