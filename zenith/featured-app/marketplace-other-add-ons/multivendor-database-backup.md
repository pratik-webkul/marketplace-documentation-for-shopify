---
title: MULTIVENDOR DATABASE BACKUP
description: MULTIVENDOR DATABASE BACKUP
author: Chirag Tyagi
---
...
1.  Go to your **Multivendor Admin Panel**.
2.  Click on the **three dots (⋮)** located at the top-right corner of the dashboard.
3.  From the dropdown menu, select **Multi-vendor Database Backup**.
4.  Then click on **Multi-vendor Backup Configuration** to begin the setup.
