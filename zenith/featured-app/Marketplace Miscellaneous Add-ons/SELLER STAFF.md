...
Admin can enable his seller to add staffs who can manage seller's account on behalf of that seller.
...
If a seller prefers not to have their staff's products auto-approved, they can disable the "Auto Approve Staff Product" configuration from the Seller Panel.

To disable the "Auto Approve Staff Product" configuration, navigate to the Seller Panel, then go to **Configuration** and select **General Configuration**.
