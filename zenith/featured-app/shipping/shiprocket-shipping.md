...
description: SHIPROCKET SHIPPING
date: 2025-07-18
author: Chirag Tyagi
---
...
**Note**\- You need to have an [**account on the shiprocket**](https://app.shiprocket.in/login) to configure the details in the app.
...
In this section, you need to configure the shiprocket shipping details such as email id, and password. You will get all these details from your [**shiprocket account.**](https://app.shiprocket.in/login)
...
For address verification, either the OTP or a call will be made to the seller's contact number.
