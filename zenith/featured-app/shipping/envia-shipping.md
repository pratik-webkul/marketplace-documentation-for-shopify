---
title: ENVIA SHIPPING
description: ENVIA SHIPPING
date: 2025-07-18
author: Chirag Tyagi
---
[Multi-Vendor Marketplace for Shopify](https://webkul.com/blog/shopify-multivendor-marketplace-new-theme-launched/) is here with another marketplace shipping feature app, i.e., **Envia Shipping**.
...
ENVIA SHIPPING FEATURE APP IS AVAILABLE **BOTH FOR RATE CALCULATION & FULFILLMENT**.
...
**AUTOMATIC GENERATE SHIPPING LABEL**
...
*   Usage As: Select whether you want to use this shipping app for both fulfillment & shipping or only just for fulfillment.
*   Choose Weight Unit: Kilogram (KG) or Pound (LB)
...
Further, the seller can configuration Envia Shipping from his panel.
...
**Fulfilling order by Envia**:

Go to **Multi-vendor marketplace seller panel** > **Orders** > **Order Listing** > **View** (under **Action**). Select the method of order fulfillment as **Envia** and fulfill the order.
...
The seller can generate a pickup request for the Envia courier services to pick the order from your warehouse:
...
Once created, the pickup request can’t be generated or edited again. Moreover, while creating the pickup request, you will get an option to select either same day pickup or next-day pickup.
