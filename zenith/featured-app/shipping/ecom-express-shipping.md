---
title: ECOM EXPRESS SHIPPING
description: ECOM EXPRESS SHIPPING
date: 2025-07-18
author: Chirag Tyagi
---
...
Please Note:- To make Ecom Express shipping feature work, you need to choose the Shopify store plan which supports the **“Real-Time Carrier-Calculated Shipping”.**

THE ECOM EXPRESS SHIPPING FEATURE APP IS AVAILABLE **ONLY FOR FULFILLMENT**.
...
But if he chooses to cancel the order he will get an option to select the reason for order cancellation.  
NOTE:- The admin will set the reason for cancellation and he can enable or disable it as per his choice.

The customer will get the notification for the same.
