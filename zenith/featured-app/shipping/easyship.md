...
Considering these traits, Webkul is here with a new feature app called Easyship in Multivendor Marketplace App.
...
**ALLOW SELLER TO CONFIGURE THEIR OWN EASYSHIP ACCOUNT:** In case you select fulfillment, you can let sellers add their details & fulfill instead of yourself adding the details.
...
For getting an access token from Easyship, please follow the below steps:
...
**WEBHOOK REGISTER FOR EASYSHIP SHIPPING:** You need to add this webhook URL to your Easyship account to manage shipping labels and shipment status.

For doing this, follow the below steps:

1.  Go to your Easyship account
...
*   Open the order that you want to create a pickup request for.
*   Click on "Actions" next to the shipping method and below the tracking number.
*   Select "Create Pickup Request" from the dropdown menu.
*   A new popup titled "Create Easyship Pickup Request" will appear.
