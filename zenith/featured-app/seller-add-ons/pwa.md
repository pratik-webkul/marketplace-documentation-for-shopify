...
*   Click on **PWA Configuration** from the drop-down menus.

On the following page, you’ll find these options:

*   SENDER ID
*   SERVER KEY
*   APPLICATION PUBLIC SERVER KEY
*   APPLICATION PRIVATE SERVER KEY
*   PUSH NOTIFICATION: To send push notification to your sellers, Keep this option enabled. Further, you can select the situations on which you want to send the notifications. The selected notifications will be auto-created & the content for the same can be edited later.
    *   Order placed
    *   Product update
    *   Seller details updated
    *   Query raised by customer
    *   Product approve
    *   Seller payment
    *   Product review
    *   Badge assigned to the seller

**How to get these keys?**
--------------------------

You can get these keys from any mobile and web application development platform like **Firebase**.
...
Clicking on **Manage Manifest** will take you to the following page:

Here, enter the PWA manifest name, tagline, configure the background color & lastly upload icon.
