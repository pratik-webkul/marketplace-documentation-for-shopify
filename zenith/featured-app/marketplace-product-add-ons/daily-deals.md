...
Now, we have **integrated the Lightning Deals App** with our popular **Multivendor Marketplace for Shopify**.

With **Multivendor Marketplace – Daily Deals**, the admin can now **grant permission to sellers**, allowing them to **create deals on their own products**.

This serves as a powerful way to **attract customers** and **boost your store’s sales**.
...
**Point to Note:** The **discounted price must be lower** than the original product price.
