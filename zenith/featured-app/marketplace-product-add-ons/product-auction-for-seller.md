---
title: PRODUCT AUCTION FOR SELLER
description: PRODUCT AUCTION FOR SELLER
date: 2025-08-04
author: Chirag Tyagi
---
...
Note:- This feature app is free of cost but to use the feature app, you need to install the product auction app on your store i.e. $30 per month over and above your currently Multivendor plan.

Suppose you opt for $60 USD per month plan, then, you will be charged $60+$30=$90 per month.
...
**To restrict sellers for Autopay, proxy bidding, and popcorn bidding.**

As we know, when the seller is adding an auction product from their marketplace seller panel then they can enable AUTO PAY, PROXY BIDDING, and POPCORN BIDDING for auction products.

But if the admin wants then he can restrict the seller to use these three features.
...
As we know, when the seller is adding an auction product from their marketplace seller panel then they can enter the time duration and price for their auction product.

But if the admin wants then he can restrict the seller to fill and update the duration and price for auction products.
...
Once the **admin enables** the following settings from the **Auction Configuration** section and clicks the **Save** button:

#### **Auction Duration Setting**

*   **Default Start Time**: 4 days from the current date/time.
*   **Default End Time**: 4 days after the auction starts.
...
These saved values will now act as **default settings** for any new auction created by the sellers from their respective seller panels.

### **Effect on Seller Panel**

When a seller adds an auction on a product:

*   The **start time** and **end time** fields will automatically be pre-filled using the admin-defined values.
*   The **base price** and **reserve price** will also be auto-filled using the values set by the admin (100 and 20,000 respectively).
*   The seller can choose to **keep these values** or **edit** them while creating the auction.
...
**Product Auction Integration Demo**
------------------------------------

Want to see the **Product Auction for Sellers** feature in action?

Check out the live demo of the **Multi-vendor Marketplace: Product Auction Integration** here:  
[View Demo](https://wk-multivendor-auction-demo.myshopify.com/pages/multivendor-marketplace-with-auction)
